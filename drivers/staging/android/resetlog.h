...
#define SIZE_KERNEL_LOG         (1024 * 1024)
...
#define SIZE_CPU_CONTEXT_INFO   (  4 * 1024)
#define SIZE_UFS_WRITE_WORK     (1024 * 1024)

#ifdef  MSM_KCJLOG_BASE
#define ADDR_KCJ_RAM_CONSOLE    (MSM_KCJLOG_BASE + SIZE_CONTROL_INFO)
...
#define ADDR_CPU_CONTEXT_INFO   (ADDR_LOGCAT_RADIO       + SIZE_LOGCAT_RADIO      )
#define ADDR_UFS_WRITE_WORK     (ADDR_CPU_CONTEXT_INFO   + SIZE_CPU_CONTEXT_INFO  )
...
typedef struct {
    ...
    uint64_t        log_buf_addr;
    uint64_t        log_buf_len_addr;
    uint64_t        log_first_idx_addr;
    uint64_t        log_next_idx_addr;
    uint64_t        m_info[MINFO_SIZE];
