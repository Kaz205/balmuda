...
/* -----------------------------------------------------
  Defines(Constants)
 ----------------------------------------------------- */
#define USE_UNIT_CONVERT /* This define should be enabled when using FW Rel7.5 or later */
...
enum sensor_micon_batch_tbl_num_e_type{
    ...
    SENSOR_BATCH_TBL_ACC_UNCAL_RAW,
    SENSOR_BATCH_TBL_ACC_UNCAL_OFS,
...
enum sensor_micon_butch_id_e_type{
    ...
    SENSOR_BATCH_ID_ACC_UNCAL_RAW = 0x0E,
    SENSOR_BATCH_ID_ACC_UNCAL_OFS = 0x0F,
...
enum sensor_micon_butch_size_e_type{
    ...
    SENSOR_BATCH_SIZE_ACC_UNCAL_RAW = 6,
    SENSOR_BATCH_SIZE_ACC_UNCAL_OFS = 6,
...
enum sensor_micon_butch_nouse_size_e_type{
    ...
    SENSOR_BATCH_NOUSE_SIZE_ACC_UNCAL_RAW = 1,
    SENSOR_BATCH_NOUSE_SIZE_ACC_UNCAL_OFS = 1,
...
struct SensorDataType {
	...
	uint32_t accel_uncalib_xy;
	uint32_t accel_uncalib_z;

	uint32_t accel_calib_offs_xy;
	uint32_t accel_calib_offs_z;
