...
#define DEBUG_DATA_FILE_PATH	"/data/touch/ILITEK_log.csv"
#define CSV_LCM_ON_PATH			"/data/touch/ilitek_mp_lcm_on_log"
#define CSV_LCM_OFF_PATH		"/data/touch/ilitek_mp_lcm_off_log"
#define POWER_STATUS_PATH		"/sys/class/power_supply/battery/status"
#define DUMP_FLASH_PATH			"/data/touch/flash_dump"
#define DUMP_IRAM_PATH			"/data/touch/iram_dump"
#else
#define DEBUG_DATA_FILE_SIZE		(10*K)
...
#ifdef KCTP_CUST
	struct kc_ts_data kctp_data;
	struct pinctrl *ts_pinctrl;
	struct pinctrl_state *gpio_state_active;
	struct pinctrl_state *gpio_state_suspend;
	int kc_func_mode;
	int kc_usb_plug_status;
	int kc_event_ctrl;
#endif /* KCTP_CUST */
...
#ifdef KCTP_CUST
extern int kctp_ctrl_pinctrl_init(void);
extern int kctp_ctrl_pinctrl_select(bool onoff);
extern int kctp_pre_init(struct device *dev);
#endif /* KCTP_CUST */
