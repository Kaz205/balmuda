...
/*
  kflcgipo for the GPIO ioctl interface
*/

#define PN544_SET_FUNC _IOW(PN544_MAGIC, 0x1F, long)


/*
 * For NFC DM Command
 *  Check NFC IRQ GPIO Input Value
*/
#define P544_GET_IRQ_STATUS _IOW(PN544_MAGIC, 0x0F, long)

#define P544_SET_FWDL_GPIO  _IOW(PN544_MAGIC, 0x20, long)
#define P544_SET_FWCK_GPIO  _IOW(PN544_MAGIC, 0x21, long)
#define P544_SET_RDTAG_GPIO _IOW(PN544_MAGIC, 0x22, long)
#define P544_SET_WINF_GPIO  _IOW(PN544_MAGIC, 0x23, long)
#define P544_SET_SETSB_GPIO _IOW(PN544_MAGIC, 0x24, long)
#define P544_SET_RELSB_GPIO _IOW(PN544_MAGIC, 0x25, long)
#define P544_SET_CKCMP_GPIO _IOW(PN544_MAGIC, 0x26, long)
