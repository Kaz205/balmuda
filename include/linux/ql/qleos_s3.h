...
/*51 - 52 */
#define FDM_DETECT			(1ULL << 51)
#define FTO_DETECT			(1ULL << 52)
...
#define M4_APP_ALGO_EVENTS 	(PD_STEP | VC_DETECTED | PS_GRADCNG | SD_CNG  | \
				...
				UWD_TARGET_DEPTH_DETECTED | UWD_MAX_DEPTH_DETECTED | WUG_DETECT | \
				FDM_DETECT | FTO_DETECT)

/* 56-63 */
#define MICON_STATE_IS_DEAD (1ULL << 58)
#define WDT_EXPIRED			(1ULL << 59)
#define HOST_CMD_ERR0		(1ULL << 60)
#define HOST_CMD_ERR1		(1ULL << 61)
#define HOST_CMD_ERR2		(1ULL << 62)

#define HOST_CMD_ERR_NOT_IMPL	(HOST_CMD_ERR0 | HOST_CMD_ERR1 | HOST_CMD_ERR2)
...
#define IRQ_PROC_PRIORITY3	(ROT_CHANGE_DETECTED | M4_BUFFER_FULL_INTR | \
							...
							FFE_BUF_BLANK_FULL | MICON_STATE_IS_DEAD)
...
#define APP_WAKEUPGESTURE			0x0B
	#define APP_WAKEUPGESTURE__WUG_OnOff		0x00
	#define APP_WAKEUPGESTURE__WUG_GetOnOff		0x80
#define APP_FACEDOWNMUTE			0x0C
	#define APP_FACEDOWNMUTE__FDM_OnOff		0x00
	#define APP_FACEDOWNMUTE__FDM_GetOnOff		0x80
	#define APP_FACEDOWNMUTE__FDM_GetInfo		0x81
#define APP_FLIPTURNON				0x0D
	#define APP_FLIPTURNON__FTO_OnOff		0x00
	#define APP_FLIPTURNON__FTO_GetOnOff		0x80
	#define APP_FLIPTURNON__FTO_GetInfo		0x81
...
#define STC_ACCEL_UNCALIBRATED_BATCHING	(6)
...
enum ignore_hostcmderr_list {
	ACC_INIT_CMD 			= 0x00010000,
	MAG_INIT_CMD 			= 0x00010100,
	GYRO_INIT_CMD 			= 0x00010200,
	PRESS_INIT_CMD 			= 0x00010300,
	TEMP_INIT_CMD 			= 0x00010400,
	PRESS2_INIT_CMD 		= 0x00010500,
	SENS_PROC_ENABLE_CMD 	= 0x00030100,
	SENS_PROC_PERIOD_CMD 	= 0x00030101,
	SENS_BATCH_ENABLE_CMD 	= 0x00030200,
	SENS_BATCH_PERIOD_CMD 	= 0x00030201,
	FFE_TIMER_ENABLE_CMD 	= 0x00060000
};
...
struct sensor_batch_period {
	...
	uint32_t accel_uncal_batch_period;
};
