...
enum pt_loader_platform_flags {
	PT_LOADER_FLAG_NONE,
	PT_LOADER_FLAG_CALIBRATE_AFTER_FW_UPGRADE = 0x01,
	/* Use CONFIG_VER field in TT_CFG to decide TT_CFG update */
	PT_LOADER_FLAG_CHECK_TTCONFIG_VERSION = 0x02,
	PT_LOADER_FLAG_CALIBRATE_AFTER_TTCONFIG_UPGRADE = 0x04,
};
#endif
